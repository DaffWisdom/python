...
create_track_list_btn = tk.Button(window, text="Create Track List", command=create_tracks_list_clicked)
...
status_lbl = tk.Label(window, bg='gray', text="", font=("Helvetica", 11))
